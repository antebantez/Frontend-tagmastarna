...
const Header = () => {
  return (
    <Row>
        ...
        <Col className='text-center bg-dark text-white p-4'>
        
          <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-train-freight-front" viewBox="0 0 16 16">
