...
const bookingReturn = () => {
  ...
  const travelerCategoryChange = async (category, change) => {
    if (numOfTravelers === travelerCategoriesSelected && change > 0) {
      ...
      setTravelerCategories(
        (previousState) => ({
          ...previousState,
          [category]: previousState[category] + change,
        }),
        setTotalPrice(ticket.getPrice(travelerCategories))
      );
            ...
            <div>
              ...
              <Row className="text-center mb-2">
                <Col>
                  <Button
                    variant="warning"
                    onClick={() => travelerCategoryChange("adult", -1)}
                  >
                    -
                  </Button>
                </Col>
                <Col className="mx-4">
                  <div className="mt-2">Vuxen: {travelerCategories.adult}</div>
                </Col>
                <Col>
                  <Button
                    variant="warning"
              ...
              <Row className="text-center mb-2">
                <Col>
                  <Button
                    variant="warning"
                    onClick={() => travelerCategoryChange("child", -1)}
                  >
                    -
                  </Button>
                </Col>
                <Col className="mx-4">
                  <div className="mt-2">Barn: {travelerCategories.child}</div>
                </Col>
                <Col>
                  <Button
                    variant="warning"
              ...
              <Row className="text-center mb-2">
                <Col>
                  <Button
                    variant="warning"
                    onClick={() => travelerCategoryChange("youth", -1)}
                  >
                    -
                  </Button>
                </Col>
                <Col xs="5">
                  <div className="mt-2">Ungdom: {travelerCategories.youth}</div>
                </Col>
                <Col>
                  <Button
                    variant="warning"
              ...
              <Row className="text-center mb-2">
                <Col>
                  <Button
                    variant="warning"
                    onClick={() => travelerCategoryChange("student", -1)}
                  >
                    -
                  </Button>
                </Col>
                <Col xs="5">
                  <div className="mt-2">
                    Student: {travelerCategories.student}
                  </div>
                </Col>
                <Col>
                  <Button
              ...
              <Row className="text-center mb-2">
                <Col>
                  <Button
                    variant="warning"
                    onClick={() => travelerCategoryChange("senior", -1)}
                  >
                    -
                  </Button>
                </Col>
              ...
              {travelerCategoriesSelected === numOfTravelers && (
                <Row className="justify-content-center">
                  <Button
                    className="w-50"
                    variant="warning"
                    onClick={() => addTravelersDataToTicket()}
                  >
                    Fortsätt
                  </Button>
                </Row>
